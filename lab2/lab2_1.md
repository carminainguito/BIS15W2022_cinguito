...
This can possibly mean that NAs indicate that a value might be missing from the data in order to actually find the mean. In other words, you're unable to get a conclusive answer because the output would not make sense. 
...
## [1] 5.888889
```
The na.rm helps remove any of the NA values within the vector which allows us to find the mean in this case.
