...
expenditures <- 
  ...
  mutate(expenditure = rownames(USPersonalExpenditure)) #pivot the year
expenditures
```
...
expenditures_long <- expenditures %>% 
  pivot_longer(-expenditure, #don't move expenditure
               names_to="year",
...
```
column names are observations - untidy data 
## Practice
